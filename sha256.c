/* Portable SHA-256 / HMAC-SHA256 (FIPS 180-4 / RFC 2104). Public domain style,
   written for embedded portability: no dynamic allocation, no dependency on
   anything beyond stdint.h/string.h. Same source compiles on x86 (for this
   test harness) and on avr-gcc (for the Arduino sketch). */
